...
export function TrendingIcon({ className = 'h-4 w-4' }: TrendingIconProps) {
  return (
    <svg 
      className={className}
      viewBox="0 0 24 24" 

...
const Navbar1 = ({ user, activeHabitsCount, onLogout, onRequestSignIn, onDeleteAll, onScrollToTop, onAvatarChange, isPreviewMode }: Navbar1Props) => {
  ...
  return (
    <div 
      className="sticky z-50 flex justify-center w-full px-4 transition-all mb-4"
      style={{
        top: 'calc(max(16px, env(safe-area-inset-top, 0px), var(--tg-safe-area-inset-top, 0px), var(--tg-content-safe-area-inset-top, 0px)) + 40px)',
      }}
    >
